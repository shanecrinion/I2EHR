    ...
    tabItems(
      ...
      tabItem(tabName = "Patient_Tab",
              ...
              tabSet(type = "tabs",
                     ...
                     tabPanel("Genomic",
                              h5("Genomic analysis for the patient"),
                              #   fileInput("file1", "Choose CEL File",
                              #             multiple = FALSE,
                              #             accept = c(".CEL")),
                              selectInput("Genomic analysis step", 
                                          "patient_genomic_step",
  ...
  shiny::observeEvent(input$patient_genomic_step,{
    ...
    if (input$patient_genomic_step == "patient_qc"){
      ...
      shiny::renderPlotly({
        ...
        bmi_all <- observations.csv[
          observations.csv$DESCRIPTION == "Body Mass Index",]
